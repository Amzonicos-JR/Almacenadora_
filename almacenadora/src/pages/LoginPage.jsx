          ...
          <div className="row">
            <div className="col-sm-6 text-black">
              ...
              <div className="px-5 ms-xl-4">
                <span className="h1 fw-bold mb-0">KINAL S.A                                 <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-person-vcard-fill" viewBox="0 0 16 16">
