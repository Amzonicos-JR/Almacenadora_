    ...
    return (
        <>
            <div className="input-group mb-3">
                <input id="inputName" type="text" className="form-control" placeholder="Search Cellar" aria-label="Recipient's username" aria-describedby="button-addon2" />
                <button className="btn btn-outline-secondary" type="button" id="button-addon2" onClick={searchCellars}>Search</button>

            </div>
            <div className="button-container text-center">
                <button onClick={searchCellars} className="btn btn-primary">Todas</button>
                <button onClick={searchAv} className="btn btn-info">Disponibles</button>
                <button onClick={searchNo} className="btn btn-info">No Disponibles</button>
                <Link to='addCellar'>
                    <button>Add Cellar</button>
                </Link>
            </div>
            <table className="table table-striped">
                ...
                <tbody>
                    {
                        cellars.map(({ name, description, location, size, availability, price }, index) => {
                            return (
