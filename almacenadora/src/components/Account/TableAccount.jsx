...
export const Table = () => {
    ...
    return (
        <>
            <h1 className="text-center">Accounts         <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38 " fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
            ...
            <div className="button-container text-center">
                <button type="button" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    Add Account  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-person-plus-fill" viewBox="0 0 16 16">
                                ...
                                <tr className="text-center" key={index}>
                                    ...
                                    <td>
                                        <div className="button-container text-center">
                                            ...
                                            <svg onClick={() => viewUpdate(_id)} data-bs-toggle="modal" data-bs-target="#exampleModal2" xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                    ...
                                    <td>
                                        ...
                                        <svg onClick={() => deleteAccount(_id)} xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
