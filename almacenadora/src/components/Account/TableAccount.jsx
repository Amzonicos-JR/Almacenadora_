...
export const Table = () => {
    ...
    return (
        <>
            <h1 className="text-center">Accounts         <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38 " fill="currentColor" className="bi bi-person-circle" viewBox="0 0 16 16">
